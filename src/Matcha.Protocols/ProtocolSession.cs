...
public sealed class ProtocolSession : IAsyncDisposable
{
    ...
    private static string? SelectServerSubprotocol(HttpRequest request)
    {
        ...
        {
            if (protocol.Equals("12.matcha", StringComparison.Ordinal))
            {
                return protocol;
            }
        }
    ...
    /// <summary>
    /// Matcha endpoints are native bot transports, never browser-facing APIs.  A browser
