...
public sealed partial class MatchaStore : IDisposable, IAsyncDisposable
{
    ...
    public MatchaStore(string? path)
    {
    ...
    public static MatchaStore DefaultLocation()
    {
        var root = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
        return new MatchaStore(Path.Combine(root, "Matcha", "Data", "matcha.sqlite3"));
    }
